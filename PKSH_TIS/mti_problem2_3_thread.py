...
class MyProblem2(ea.Problem):
    def __init__(self, M=3, pooltype='Thread', num=4):
        name = 'MyProblem2'
        maxormins = [1] * M
    ...
    def evalVars(self, Vars):
        ...
        i = 0
        for _ in res:
            r1[i] = [1.5*ii for ii in _[0]]
            r2[i] = [1.5*ii for ii in _[1]]
            r3[i] = [1.5*ii for ii in _[2]]
            CV[i] = _[3]
            i += 1
        # print(r1)
...
def subAimFunc(args):
    ...
    _i, _r, _m = util.mti2_three(x1, x2, i, num)
